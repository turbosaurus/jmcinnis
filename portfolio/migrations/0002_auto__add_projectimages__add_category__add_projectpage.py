...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectPage'
        db.create_table(u'portfolio_projectpage', (
            ...
            ('project_description', self.gf('mezzanine.core.fields.RichTextField')()),
        ))
        db.send_create_signal(u'portfolio', ['ProjectPage'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ProjectPage'
        db.delete_table(u'portfolio_projectpage')
